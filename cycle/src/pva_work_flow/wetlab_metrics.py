...
from .chain_search import resolve_chain_parent
from .io_artifacts import aggregate_cof_from_row
from .utils import _to_float_or_none, load_allowed_materials
...
def _inventory_metrics(
    ...
    if inventory_csv is None:
        inventory_csv = Path(__file__).resolve().parents[2] / "materials" / "materials_en.csv"
